...
public final class C0008SegmentedByteString extends ByteString {
    ...
    public C0008SegmentedByteString(byte[][] segments, int[] directory) {
    ...
    public ByteString digest$okio(String algorithm) {
        ...
        for (int s$iv = 0; s$iv < segmentCount$iv; s$iv++) {
            ...
            $this$digest_u24lambda_u241.update(data, segmentPos$iv, byteCount);
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        int beginSegment$iv = okio.internal.SegmentedByteString.segment(this, beginIndex);
        int endSegment$iv = okio.internal.SegmentedByteString.segment(this, endIndex$iv - 1);
        ...
        int segmentOffset$iv = beginSegment$iv != 0 ? getDirectory()[beginSegment$iv - 1] : 0;
        int length = newSegments$iv.length;
        newDirectory$iv[length] = newDirectory$iv[length] + (beginIndex - segmentOffset$iv);
        return new C0008SegmentedByteString(newSegments$iv, newDirectory$iv);
    }

    @Override // okio.ByteString
    public byte internalGet$okio(int pos) {
        SegmentedByteString.checkOffsetAndCount(getDirectory()[getSegments().length - 1], pos, 1L);
        int segment$iv = okio.internal.SegmentedByteString.segment(this, pos);
    ...
    public void write$okio(Buffer buffer, int offset, int byteCount) {
        C0008SegmentedByteString $this$commonWrite$iv;
        Intrinsics.checkNotNullParameter(buffer, "buffer");
        C0008SegmentedByteString $this$commonWrite$iv2 = this;
        int endIndex$iv$iv = offset + byteCount;
        int s$iv$iv = okio.internal.SegmentedByteString.segment($this$commonWrite$iv2, offset);
    ...
    public boolean rangeEquals(int offset, ByteString other, int otherOffset, int byteCount) {
        ...
        C0008SegmentedByteString $this$commonRangeEquals$iv = this;
        if (offset >= 0 && offset <= $this$commonRangeEquals$iv.size() - byteCount) {
            int otherOffset$iv = otherOffset;
            int endIndex$iv$iv = offset + byteCount;
            int s$iv$iv = okio.internal.SegmentedByteString.segment($this$commonRangeEquals$iv, offset);
            int pos$iv$iv = offset;
            while (pos$iv$iv < endIndex$iv$iv) {
                ...
                C0008SegmentedByteString $this$commonRangeEquals$iv2 = $this$commonRangeEquals$iv;
    ...
    public boolean rangeEquals(int offset, byte[] other, int otherOffset, int byteCount) {
        ...
        int otherOffset$iv = otherOffset;
        int endIndex$iv$iv = offset + byteCount;
        int s$iv$iv = okio.internal.SegmentedByteString.segment(this, offset);
        int pos$iv$iv = offset;
        while (pos$iv$iv < endIndex$iv$iv) {
            ...
            byte[] data$iv = getSegments()[s$iv$iv];
            if (!SegmentedByteString.arrayRangeEquals(data$iv, offset$iv$iv, other, otherOffset$iv, byteCount$iv$iv)) {
                return false;
            }
            otherOffset$iv += byteCount$iv$iv;
            pos$iv$iv += byteCount$iv$iv;
    ...
    public void copyInto(int offset, byte[] target, int targetOffset, int byteCount) {
        ...
        C0008SegmentedByteString $this$commonCopyInto$iv = this;
        ...
        int endIndex$iv$iv = offset + byteCount;
        int s$iv$iv = okio.internal.SegmentedByteString.segment($this$commonCopyInto$iv, offset);
        int pos$iv$iv = offset;
        while (pos$iv$iv < endIndex$iv$iv) {
