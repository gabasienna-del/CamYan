...
public final class SegmentedByteString {
    ...
    public static final int segment(C0008SegmentedByteString $this$segment, int pos) {
    ...
    public static final void forEachSegment(C0008SegmentedByteString $this$forEachSegment, Function3<? super byte[], ? super Integer, ? super Integer, Unit> action) {
    ...
    private static final void forEachSegment(C0008SegmentedByteString $this$forEachSegment, int beginIndex, int endIndex, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
    ...
    public static final ByteString commonSubstring(C0008SegmentedByteString $this$commonSubstring, int beginIndex, int endIndex) {
        ...
        int segmentOffset = beginSegment != 0 ? $this$commonSubstring.getDirectory()[beginSegment - 1] : 0;
        int length = newSegments.length;
        newDirectory[length] = newDirectory[length] + (beginIndex - segmentOffset);
        return new C0008SegmentedByteString(newSegments, newDirectory);
    }

    public static final byte commonInternalGet(C0008SegmentedByteString $this$commonInternalGet, int pos) {
        Intrinsics.checkNotNullParameter($this$commonInternalGet, "<this>");
        okio.SegmentedByteString.checkOffsetAndCount($this$commonInternalGet.getDirectory()[$this$commonInternalGet.getSegments().length - 1], pos, 1L);
    ...
    public static final int commonGetSize(C0008SegmentedByteString $this$commonGetSize) {
    ...
    public static final byte[] commonToByteArray(C0008SegmentedByteString $this$commonToByteArray) {
    ...
    public static final void commonWrite(C0008SegmentedByteString $this$commonWrite, Buffer buffer, int offset, int byteCount) {
        int $i$f$commonWrite;
    ...
    public static final boolean commonRangeEquals(C0008SegmentedByteString $this$commonRangeEquals, int offset, ByteString other, int otherOffset, int byteCount) {
    ...
    public static final boolean commonRangeEquals(C0008SegmentedByteString $this$commonRangeEquals, int offset, byte[] other, int otherOffset, int byteCount) {
        Intrinsics.checkNotNullParameter($this$commonRangeEquals, "<this>");
        Intrinsics.checkNotNullParameter(other, "other");
    ...
    public static final void commonCopyInto(C0008SegmentedByteString $this$commonCopyInto, int offset, byte[] target, int targetOffset, int byteCount) {
    ...
    public static final boolean commonEquals(C0008SegmentedByteString $this$commonEquals, Object other) {
    ...
    public static final int commonHashCode(C0008SegmentedByteString $this$commonHashCode) {
