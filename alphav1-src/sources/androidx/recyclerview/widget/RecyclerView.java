...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, androidx.recyclerview.R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, NESTED_SCROLLING_ATTRS, attrs, a2, defStyleAttr, 0);
        }
        boolean nestedScrollingEnabled = a2.getBoolean(0, true);
        a2.recycle();
    ...
    */
        ...
        switch (action) {
            ...
            case 1:
                ...
                if (!canScrollHorizontally) {
                    ...
                    xvel = -this.mVelocityTracker.getXVelocity(this.mScrollPointerId);
                }
                if (!canScrollVertically) {
                    yvel = 0.0f;
                } else {
                    yvel = -this.mVelocityTracker.getYVelocity(this.mScrollPointerId);
                }
            ...
            case 2:
                ...
                if (this.mScrollState != i) {
                    ...
                    if (!dispatchNestedPreScroll(canScrollHorizontally ? dx : 0, canScrollVertically ? dy : 0, this.mReusableIntPair, this.mScrollOffset, 0)) {
                        ...
                        int dx4 = dx - this.mReusableIntPair[0];
                        c = 1;
                        int dy4 = dy - this.mReusableIntPair[1];
                    ...
                    this.mLastTouchY = y2 - this.mScrollOffset[c];
                    if (scrollByInternal(canScrollHorizontally ? dx2 : 0, canScrollVertically ? dy2 : 0, e)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
    ...
    public void draw(Canvas c) {
        ...
        if (this.mLeftGlow != null && !this.mLeftGlow.isFinished()) {
            ...
            i2 = (this.mLeftGlow == null || !this.mLeftGlow.draw(c)) ? 0 : 1;
        ...
        if (this.mTopGlow != null && !this.mTopGlow.isFinished()) {
            ...
            i2 |= (this.mTopGlow == null || !this.mTopGlow.draw(c)) ? 0 : 1;
        ...
        if (this.mRightGlow != null && !this.mRightGlow.isFinished()) {
            ...
            i2 |= (this.mRightGlow == null || !this.mRightGlow.draw(c)) ? 0 : 1;
        ...
        if (this.mBottomGlow != null && !this.mBottomGlow.isFinished()) {
            ...
            i2 |= (this.mBottomGlow == null || !this.mBottomGlow.draw(c)) ? 0 : 1;
    ...
    public final class Recycler {
        ...
        public ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (holder2 != null) {
                ...
                if (holder2 == null && this.mViewCacheExtension != null && (view = this.mViewCacheExtension.getViewForPositionAndType(this, position, type)) != null) {
