    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (true) {
            if (layoutState.hasMore(state)) {
                ...
                boolean z3 = span3 == -1 ? r10 : r9;
                if (z3) {
                    Span nextSpan = layoutParams.mFullSpan ? this.mSpans[r9] : getNextSpan(layoutState);
                ...
                if (layoutState.mLayoutDirection == r10) {
                    if (layoutParams.mFullSpan) {
                        decoratedMeasurement = getMaxEnd(i5);
                    } else {
                        decoratedMeasurement = span.getEndLine(i5);
                    }
                    i3 = this.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                    ...
                    if (z3 && layoutParams.mFullSpan) {
                        ...
                        createFullSpanItemFromStart.mGapDir = r10;
                ...
                if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                    if (z3) {
                        ...
                        if ((layoutState.mLayoutDirection == r10 ? (areAllEndsEqual() ? 1 : 0) ^ r10 : (areAllStartsEqual() ? 1 : 0) ^ r10) != 0) {
                            LazySpanLookup.FullSpanItem fullSpanItem = this.mLazySpanLookup.getFullSpanItem(viewLayoutPosition);
                            if (fullSpanItem != null) {
                                fullSpanItem.mHasUnwantedGapAfter = r10;
                            }
                            this.mLaidOutInvalidFullSpan = r10;
                        }
                    }
                ...
                if (isLayoutRTL() && this.mOrientation == r10) {
                    int endAfterPadding = layoutParams.mFullSpan ? this.mSecondaryOrientation.getEndAfterPadding() : this.mSecondaryOrientation.getEndAfterPadding() - (((this.mSpanCount - r10) - span.mIndex) * this.mSizePerSpan);
                    ...
                    int i8 = startAfterPadding2;
                    decoratedMeasurement2 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i8;
                    i4 = i8;
                }
                if (this.mOrientation == r10) {
                    span2 = span;
                    layoutDecoratedWithMargins(next, i4, i6, decoratedMeasurement2, i7);
                } else {
                    span2 = span;
                    layoutDecoratedWithMargins(next, i6, i4, i7, decoratedMeasurement2);
                }
                if (layoutParams.mFullSpan) {
        ...
        return maxEnd > 0 ? Math.min(layoutState.mAvailable, maxEnd) : i2;
    }
