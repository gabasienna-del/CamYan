...
public class ConstraintSet {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    ...
                    case ConstraintSet.CONSTRAINT_TAG /* 77 */:
                        ...
                        break;
                    case ConstraintSet.CONSTRAINED_WIDTH /* 80 */:
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            this.mConstraints.put(key, set.mConstraints.get(key).m11clone());
        }
    }
    ...
    */
    public void applyToInternal(androidx.constraintlayout.widget.ConstraintLayout r10, boolean r11) {
        /*
    ...
    public void dump(MotionScene scene, int... ids) {
        ...
        for (Integer id : (Integer[]) set.toArray(new Integer[0])) {
            Constraint constraint = this.mConstraints.get(id);
