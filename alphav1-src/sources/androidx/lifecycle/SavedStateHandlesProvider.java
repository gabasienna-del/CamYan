...
public final class SavedStateHandlesProvider implements SavedStateRegistry.SavedStateProvider {
    ...
    public Bundle saveState() {
        ...
        for (Map.Entry element$iv : $this$forEach$iv.entrySet()) {
            ...
            Bundle savedState = handle.getSavedStateProvider().saveState();
    ...
    public final void performRestore() {
        if (!this.restored) {
            Bundle newState = this.savedStateRegistry.consumeRestoredStateForKey("androidx.lifecycle.internal.SavedStateHandlesProvider");
            Bundle $this$performRestore_u24lambda_u245 = new Bundle();
            Bundle it = this.restoredState;
            if (it != null) {
                $this$performRestore_u24lambda_u245.putAll(it);
            }
            if (newState != null) {
                $this$performRestore_u24lambda_u245.putAll(newState);
            }
            this.restoredState = $this$performRestore_u24lambda_u245;
            this.restored = true;
            getViewModel();
        }
    }
