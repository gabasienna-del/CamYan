...
public class ChangeTransform extends Transition {
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        Listener listener = new Listener(view, transforms, pathAnimatorMatrix, endMatrix, handleParentChange, this.mUseOverlay);
    ...
    public static class Listener extends AnimatorListenerAdapter {
        ...
        public void onAnimationPause(Animator animation) {
            Matrix currentMatrix = this.mPathAnimatorMatrix.getMatrix();
