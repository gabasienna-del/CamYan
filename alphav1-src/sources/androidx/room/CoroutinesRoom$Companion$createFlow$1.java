                ...
                case 0:
                    ...
                    ?? r13 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                        ...
                        public void onInvalidated(Set<String> tables) {
                            ...
                            observerChannel.mo1683trySendJP2dKIU(Unit.INSTANCE);
                        }
                    };
                    observerChannel.mo1683trySendJP2dKIU(Unit.INSTANCE);
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, queryContext, null, new C00041(this.$db, r13, observerChannel, this.$callable, resultChannel, null), 2, null);
                    this.label = 1;
