...
@Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0007\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, d2 = {"Landroidx/room/CoroutinesRoom;", "", "()V", "Companion", "room-ktx_release"}, k = 1, mv = {1, 7, 1}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
...
public final class CoroutinesRoom {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        public final <R> Object execute(RoomDatabase db, boolean inTransaction, Callable<R> callable, Continuation<? super R> continuation) {
            ...
            if (transactionElement == null || (context = transactionElement.getTransactionDispatcher()) == null) {
                context = inTransaction ? CoroutinesRoomKt.getTransactionDispatcher(db) : CoroutinesRoomKt.getQueryDispatcher(db);
            }
            return BuildersKt.withContext(context, new CoroutinesRoom$Companion$execute$2(callable, null), continuation);
        }

        @JvmStatic
        public final <R> Object execute(RoomDatabase db, boolean inTransaction, final CancellationSignal cancellationSignal, Callable<R> callable, Continuation<? super R> continuation) {
            CoroutineDispatcher context;
            final Job job;
            if (db.isOpen() && db.inTransaction()) {
                return callable.call();
            ...
            job = BuildersKt__Builders_commonKt.launch$default(GlobalScope.INSTANCE, context, null, new CoroutinesRoom$Companion$execute$4$job$1(callable, continuation2, null), 2, null);
