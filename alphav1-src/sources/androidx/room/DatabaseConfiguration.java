...
public class DatabaseConfiguration {
    ...
    */
    public DatabaseConfiguration(android.content.Context r22, java.lang.String r23, androidx.sqlite.db.SupportSQLiteOpenHelper.Factory r24, androidx.room.RoomDatabase.MigrationContainer r25, java.util.List<? extends androidx.room.RoomDatabase.Callback> r26, boolean r27, androidx.room.RoomDatabase.JournalMode r28, java.util.concurrent.Executor r29, java.util.concurrent.Executor r30, boolean r31, boolean r32, boolean r33, java.util.Set<java.lang.Integer> r34) {
        /*
            r21 = this;
            r13 = r22
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public DatabaseConfiguration(android.content.Context r22, java.lang.String r23, androidx.sqlite.db.SupportSQLiteOpenHelper.Factory r24, androidx.room.RoomDatabase.MigrationContainer r25, java.util.List<? extends androidx.room.RoomDatabase.Callback> r26, boolean r27, androidx.room.RoomDatabase.JournalMode r28, java.util.concurrent.Executor r29, java.util.concurrent.Executor r30, boolean r31, boolean r32, boolean r33, java.util.Set<java.lang.Integer> r34, java.lang.String r35, java.io.File r36) {
        /*
            r21 = this;
            r15 = r22
            java.lang.String r0 = "context"
    ...
    */
    ...
    public boolean isMigrationRequired(int fromVersion, int toVersion) {
        ...
        if (isDowngrade && this.allowDestructiveMigrationOnDowngrade) {
            return false;
        }
        return this.requireMigration && (this.migrationNotRequiredFrom == null || !this.migrationNotRequiredFrom.contains(Integer.valueOf(fromVersion)));
    }
}
