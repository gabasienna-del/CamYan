...
public final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    public void execSQL(final String sql, Object[] bindArgs) {
        Intrinsics.checkNotNullParameter(sql, "sql");
        Intrinsics.checkNotNullParameter(bindArgs, "bindArgs");
        final List inputArguments = new ArrayList();
        inputArguments.addAll(CollectionsKt.listOf(bindArgs));
        this.queryCallbackExecutor.execute(new Runnable() { // from class: androidx.room.QueryInterceptorDatabase$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                QueryInterceptorDatabase.execSQL$lambda$11(QueryInterceptorDatabase.this, sql, inputArguments);
            }
        });
        this.delegate.execSQL(sql, new List[]{inputArguments});
    }
