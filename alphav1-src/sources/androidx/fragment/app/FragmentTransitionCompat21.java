...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    ...
    static class Api19Impl {
        ...
        static void addListener(Transition transition, Transition.TransitionListener listener) {
            transition.addListener(listener);
        }

        static void removeListener(Transition transition, Transition.TransitionListener listener) {
