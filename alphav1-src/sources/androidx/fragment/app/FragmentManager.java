...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m48lambda$new$0$androidxfragmentappFragmentManager(Configuration newConfig) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m49lambda$new$1$androidxfragmentappFragmentManager(Integer level) {
    ...
    public /* synthetic */ void m50lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m51lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo info) {
        if (isParentAdded()) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle savedState = m47lambda$attachController$4$androidxfragmentappFragmentManager();
