...
public class WorkForegroundRunnable implements Runnable {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WorkForegroundRunnable.this.m82lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(foregroundFuture);
            }
        });
    ...
    public /* synthetic */ void m82lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture foregroundFuture) {
