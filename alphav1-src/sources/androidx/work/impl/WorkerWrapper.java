...
public class WorkerWrapper implements Runnable {
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WorkerWrapper.this.m78lambda$runWorker$0$androidxworkimplWorkerWrapper(runExpedited);
                }
    ...
    public /* synthetic */ void m78lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture runExpedited) {
