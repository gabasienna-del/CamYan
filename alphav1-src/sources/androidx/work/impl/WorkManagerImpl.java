...
public class WorkManagerImpl extends WorkManager {
    ...
    public Operation cancelWorkById(UUID id) {
        ...
        this.mWorkTaskExecutor.executeOnTaskThread(runnable);
    ...
    public LiveData<WorkInfo> getWorkInfoByIdLiveData(UUID id) {
        ...
        return LiveDataUtils.dedupedMappedLiveDataFor(inputLiveData, new Function<List<WorkSpec.WorkInfoPojo>, WorkInfo>() { // from class: androidx.work.impl.WorkManagerImpl.2
    ...
    public ListenableFuture<WorkInfo> getWorkInfoById(UUID id) {
        ...
        this.mWorkTaskExecutor.getSerialTaskExecutor().execute(runnable);
