...
public final class ConstraintTrackingWorker extends ListenableWorker implements OnConstraintsStateChangedListener {
    ...
    private final void setupAndRunConstraintTrackingWork() {
        ...
        CoroutineDispatcher dispatcher = workManagerImpl.getWorkTaskExecutor().getTaskCoroutineDispatcher();
        Intrinsics.checkNotNullExpressionValue(dispatcher, "workManagerImpl.workTask…r.taskCoroutineDispatcher");
        final Job job = WorkConstraintsTrackerKt.listen(workConstraintsTracker, workSpec, dispatcher, this);
        ...
        if (workConstraintsTracker.areAllConstraintsMet(workSpec)) {
            ...
            try {
                ...
                innerFuture.addListener(new Runnable() { // from class: androidx.work.impl.workers.ConstraintTrackingWorker$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
                        ConstraintTrackingWorker.setupAndRunConstraintTrackingWork$lambda$3(ConstraintTrackingWorker.this, innerFuture);
                    }
    ...
    public void onStopped() {
        ...
        if (delegateInner != null && !delegateInner.isStopped()) {
            int reason = Build.VERSION.SDK_INT >= 31 ? getStopReason() : 0;
