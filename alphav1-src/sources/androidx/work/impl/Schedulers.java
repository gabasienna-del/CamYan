...
public class Schedulers {
    ...
    public static /* synthetic */ void lambda$registerRescheduling$0(List schedulers, WorkGenerationalId id, Configuration configuration, WorkDatabase workDatabase) {
