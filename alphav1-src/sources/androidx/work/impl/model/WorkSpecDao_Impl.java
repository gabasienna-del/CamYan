...
public final class WorkSpecDao_Impl implements WorkSpecDao {
    ...
    public List<WorkSpec.WorkInfoPojo> getWorkStatusPojoForIds(final List<String> ids) {
        ...
        String _tmpKey_3 = _stringBuilder2.toString();
        int _argCount = _inputSize2 + 0;
        RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_tmpKey_3, _argCount);
        int _argIndex = 1;
                    ...
                    try {
                        ...
                        while (_cursor.moveToNext()) {
                            ...
                            try {
                                ...
                                ArrayList<String> _tmpTagsCollection_12 = _tmpTagsCollection_1 == null ? new ArrayList<>() : _tmpTagsCollection_1;
                                ArrayList<Data> _tmpProgressCollection_1 = _collectionProgress3.get(_cursor.getString(0));
                                WorkSpec.WorkInfoPojo _item_1 = new WorkSpec.WorkInfoPojo(_tmpId, _tmpState, _tmpOutput, _tmpInitialDelay, _tmpIntervalDuration, _tmpFlexDuration, _tmpConstraints, _tmpRunAttemptCount, _tmpBackoffPolicy, _tmpBackoffDelayDuration, _tmpLastEnqueueTime, _tmpPeriodCount, _tmpGeneration, _tmpNextScheduleTimeOverride, _tmpStopReason, _tmpTagsCollection_12, _tmpProgressCollection_1 == null ? new ArrayList<>() : _tmpProgressCollection_1);
                                _result.add(_item_1);
                                _tmpKey_3 = _sql;
                ...
                try {
                    ...
                    try {
                        ...
                        while (_cursor.moveToNext()) {
                            ...
                            WorkSpec.WorkInfoPojo _item_1 = new WorkSpec.WorkInfoPojo(_tmpId, _tmpState, _tmpOutput, _tmpInitialDelay, _tmpIntervalDuration, _tmpFlexDuration, _tmpConstraints, _tmpRunAttemptCount, _tmpBackoffPolicy, _tmpBackoffDelayDuration, _tmpLastEnqueueTime, _tmpPeriodCount, _tmpGeneration, _tmpNextScheduleTimeOverride, _tmpStopReason, _tmpTagsCollection_1, _tmpProgressCollection_1);
                            _result.add(_item_1);
                            _cursorIndexOfRunAttemptCount = _cursorIndexOfRunAttemptCount2;
                            _collectionProgress3 = _collectionProgress3;
    ...
    public List<WorkSpec> getEligibleWorkForScheduling(final int schedulerLimit) {
        ...
        Cursor _cursor = DBUtil.query(this.__db, _statement2, false, null);
        try {
            _cursorIndexOfId = CursorUtil.getColumnIndexOrThrow(_cursor, "id");
