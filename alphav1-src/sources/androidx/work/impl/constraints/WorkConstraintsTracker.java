...
public final class WorkConstraintsTracker {
    ...
    public final Flow<ConstraintsState> track(WorkSpec spec) {
        ...
        return FlowKt.distinctUntilChanged(new Flow<ConstraintsState>() { // from class: androidx.work.impl.constraints.WorkConstraintsTracker$track$$inlined$combine$1
            ...
            public Object collect(FlowCollector<? super ConstraintsState> flowCollector, Continuation $completion) {
                ...
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, new Function0<ConstraintsState[]>() { // from class: androidx.work.impl.constraints.WorkConstraintsTracker$track$$inlined$combine$1.2
    ...
    public final boolean areAllConstraintsMet(WorkSpec workSpec) {
        ...
        if (!controllers.isEmpty()) {
            Logger.get().debug(WorkConstraintsTrackerKt.access$getTAG$p(), "Work " + workSpec.id + " constrained by " + CollectionsKt.joinToString$default(controllers, null, null, null, 0, null, new Function1<ConstraintController<?>, CharSequence>() { // from class: androidx.work.impl.constraints.WorkConstraintsTracker$areAllConstraintsMet$1
