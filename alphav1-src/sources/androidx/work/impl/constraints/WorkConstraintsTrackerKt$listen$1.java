    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                this.label = 1;
                if (track.collect(new FlowCollector() { // from class: androidx.work.impl.constraints.WorkConstraintsTrackerKt$listen$1.1
                    public final Object emit(ConstraintsState it, Continuation<? super Unit> continuation) {
                        OnConstraintsStateChangedListener.this.onConstraintsStateChanged(workSpec, it);
