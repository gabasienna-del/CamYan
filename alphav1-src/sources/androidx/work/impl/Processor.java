...
public class Processor implements ForegroundProcessor {
    ...
    public boolean startWork(StartStopToken startStopToken, WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        WorkSpec workSpec = (WorkSpec) this.mWorkDatabase.runInTransaction(new Callable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda1
            ...
            public final Object call() {
                return Processor.this.m75lambda$startWork$0$androidxworkimplProcessor(tags, workSpecId);
            }
        });
        if (workSpec == null) {
                ...
                try {
                    ...
                    future.addListener(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda2
                        ...
                        public final void run() {
                            Processor.this.m76lambda$startWork$1$androidxworkimplProcessor(future, workWrapper);
                        }
    ...
    public /* synthetic */ WorkSpec m75lambda$startWork$0$androidxworkimplProcessor(ArrayList tags, String workSpecId) throws Exception {
    ...
    public /* synthetic */ void m76lambda$startWork$1$androidxworkimplProcessor(ListenableFuture future, WorkerWrapper workWrapper) {
    ...
    private void runOnExecuted(final WorkGenerationalId id, final boolean needsReschedule) {
        this.mWorkTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.Processor$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Processor.this.m74lambda$runOnExecuted$2$androidxworkimplProcessor(id, needsReschedule);
            }
        });
    }
    ...
    public /* synthetic */ void m74lambda$runOnExecuted$2$androidxworkimplProcessor(WorkGenerationalId id, boolean needsReschedule) {
        synchronized (this.mLock) {
            for (ExecutionListener executionListener : this.mOuterListeners) {
                executionListener.onExecuted(id, needsReschedule);
            }
