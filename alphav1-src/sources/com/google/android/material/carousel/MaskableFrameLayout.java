...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    public void setShapeAppearanceModel(ShapeAppearanceModel shapeAppearanceModel) {
        this.shapeAppearanceModel = shapeAppearanceModel.withTransformedCornerSizes(new ShapeAppearanceModel.CornerSizeUnaryOperator() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda0
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda1
            ...
            public final void run(Canvas canvas2) {
                MaskableFrameLayout.this.m88x418c47c0(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m88x418c47c0(Canvas x$0) {
