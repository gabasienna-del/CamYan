...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.showMarker = a.getBoolean(R.styleable.Tooltip_showMarker, true);
        if (this.showMarker) {
        ...
        int background = MaterialColors.getColor(this.context, android.R.attr.colorBackground, TooltipDrawable.class.getCanonicalName());
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(this.text, 0, this.text.length(), bounds.centerX(), y, this.textDrawableHelper.getTextPaint());
    }
