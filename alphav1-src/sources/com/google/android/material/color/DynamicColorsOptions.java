...
public class DynamicColorsOptions {
    ...
    private DynamicColorsOptions(Builder builder) {
        ...
        if (builder.contentBasedSourceColor != null) {
            ...
            if (builder.contentBasedSourceBitmap == null) {
                return;
            }
    ...
    public static class Builder {
        ...
        public Builder setContentBasedSource(Bitmap contentBasedSource) {
            this.contentBasedSourceBitmap = contentBasedSource;
            this.contentBasedSourceColor = null;
            return this;
        }

        public Builder setContentBasedSource(int contentBasedSource) {
            this.contentBasedSourceBitmap = null;
            this.contentBasedSourceColor = Integer.valueOf(contentBasedSource);
            return this;
        }
