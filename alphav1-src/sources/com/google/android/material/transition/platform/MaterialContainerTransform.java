...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        if (viewIdOverride != -1) {
            ...
            View snapshotView = (View) transitionValues.view.getTag(com.google.android.material.R.id.mtrl_motion_snapshot_view);
        ...
        if (ViewCompat.isLaidOut(snapshotView2) || snapshotView2.getWidth() != 0 || snapshotView2.getHeight() != 0) {
            ...
            transitionValues.values.put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(snapshotView2, bounds, shapeAppearanceModelOverride));
        }
    }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{com.google.android.material.R.attr.transitionShapeAppearance});
    ...
    private void maybeApplyThemeValues(Context context, boolean entering) {
        ...
        TransitionUtils.maybeApplyThemeDuration(this, context, entering ? com.google.android.material.R.attr.motionDurationLong2 : com.google.android.material.R.attr.motionDurationMedium4);
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float progress) {
            ...
            float motionPathX2 = this.motionPathPosition[0];
            float motionPathY2 = this.motionPathPosition[1];
