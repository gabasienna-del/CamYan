...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ShapeAppearanceModel shapeAppearance = ShapeAppearanceModel.builder(context2, attrs, defStyleAttr, DEF_STYLE_RES, ShapeAppearanceModel.PILL).build();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int w = View.resolveSize(preferredSize, widthMeasureSpec);
        int h = View.resolveSize(preferredSize, heightMeasureSpec);
        int d = Math.min(w, h);
    ...
    private void getTouchTargetRect(Rect rect) {
        ...
        int touchTargetPadding = this.impl.getTouchTargetPadding();
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (ev.getAction() == 0) {
            ...
            if (!this.touchArea.contains((int) ev.getX(), (int) ev.getY())) {
                return false;
            }
        }
