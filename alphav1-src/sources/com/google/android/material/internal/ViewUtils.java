...
public class ViewUtils {
    ...
    public static void requestFocusAndShowKeyboard(final View view, final boolean useWindowInsetsController) {
        view.requestFocus();
        view.post(new Runnable() { // from class: com.google.android.material.internal.ViewUtils$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ViewUtils.showKeyboard(view, useWindowInsetsController);
            }
        });
    }
    ...
    public static Rect calculateOffsetRectFromBounds(View view, View offsetView) {
        ...
        int fromRight = offsetView.getWidth() + fromLeft;
        int fromBottom = offsetView.getHeight() + fromTop;
