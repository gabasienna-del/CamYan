...
public class TabLayout extends HorizontalScrollView {
            ...
            if (this.selectedTabTextAppearance != -1) {
                ...
                try {
                    ...
                    if (selectedTabTextColor != null) {
                        this.tabTextColors = createColorStateList(this.tabTextColors.getDefaultColor(), selectedTabTextColor.getColorForState(new int[]{android.R.attr.state_selected}, selectedTabTextColor.getDefaultColor()));
                    }
                } finally {
                }
            }
    ...
    public final class TabView extends LinearLayout {
        ...
        private void updateTextAndIcon(TextView textView, ImageView iconView, boolean addDefaultMargins) {
            ...
            if (textView != null) {
                showingText = hasText && this.tab.labelVisibilityMode == 1;
