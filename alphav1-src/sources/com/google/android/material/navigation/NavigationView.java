...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        boolean textAppearanceActiveBoldEnabled = a.getBoolean(com.google.android.material.R.styleable.NavigationView_itemTextAppearanceActiveBoldEnabled, true);
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.navigation.NavigationView$$ExternalSyntheticLambda0
            ...
            public final void run(Canvas canvas2) {
                NavigationView.this.m137xb790515(canvas2);
            }
        });
    }
    ...
    public /* synthetic */ void m137xb790515(Canvas x$0) {
