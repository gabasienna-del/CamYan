...
public class SearchBarAnimationHelper {
    ...
    public void startExpandAnimation(final SearchBar searchBar, final View expandedView, final AppBarLayout appBarLayout, final boolean skipAnimation) {
        ...
        expandedView.post(new Runnable() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                SearchBarAnimationHelper.this.m140x1b96b119(searchBar, expandedView, appBarLayout, skipAnimation);
            }
        });
    }
    ...
    public /* synthetic */ void m140x1b96b119(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
    ...
    private Animator getFadeOutChildrenAnimator(SearchBar searchBar, final View expandedView) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
