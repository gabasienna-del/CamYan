...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    private final void verifyClientState() {
        ...
        Iterable $this$none$iv2 = this.connectionSpecs;
        if (!($this$none$iv2 instanceof Collection) || !((Collection) $this$none$iv2).isEmpty()) {
            Iterator it = $this$none$iv2.iterator();
            while (true) {
                if (it.hasNext()) {
                    Object element$iv = it.next();
                    ConnectionSpec it2 = (ConnectionSpec) element$iv;
    ...
    public final List<Interceptor> m1850deprecated_interceptors() {
        return this.interceptors;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "networkInterceptors", imports = {}))
    /* renamed from: -deprecated_networkInterceptors, reason: not valid java name */
    public final List<Interceptor> m1851deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final SSLSocketFactory m1860deprecated_sslSocketFactory() {
        return sslSocketFactory();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "connectionSpecs", imports = {}))
    /* renamed from: -deprecated_connectionSpecs, reason: not valid java name */
    public final List<ConnectionSpec> m1842deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "protocols", imports = {}))
    /* renamed from: -deprecated_protocols, reason: not valid java name */
    public final List<Protocol> m1853deprecated_protocols() {
        return this.protocols;
    }
    ...
    public static final class Builder {
        ...
        public final Builder dispatcher(Dispatcher dispatcher) {
            ...
            Builder $this$dispatcher_u24lambda_u240 = this;
        ...
        public final Builder connectionPool(ConnectionPool connectionPool) {
            ...
            Builder $this$connectionPool_u24lambda_u241 = this;
        ...
        public final Builder addInterceptor(Interceptor interceptor) {
            ...
            Builder $this$addInterceptor_u24lambda_u242 = this;
            $this$addInterceptor_u24lambda_u242.interceptors.add(interceptor);
            return this;
        }

        /* renamed from: -addInterceptor, reason: not valid java name */
        public final Builder m1862addInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
        ...
        public final Builder addNetworkInterceptor(Interceptor interceptor) {
            Intrinsics.checkNotNullParameter(interceptor, "interceptor");
            Builder $this$addNetworkInterceptor_u24lambda_u243 = this;
            $this$addNetworkInterceptor_u24lambda_u243.networkInterceptors.add(interceptor);
            return this;
        }

        /* renamed from: -addNetworkInterceptor, reason: not valid java name */
        public final Builder m1863addNetworkInterceptor(final Function1<? super Interceptor.Chain, Response> block) {
            Intrinsics.checkNotNullParameter(block, "block");
        ...
        public final Builder eventListener(EventListener eventListener) {
            ...
            Builder $this$eventListener_u24lambda_u244 = this;
        ...
        public final Builder eventListenerFactory(EventListener.Factory eventListenerFactory) {
            ...
            Builder $this$eventListenerFactory_u24lambda_u245 = this;
        ...
        public final Builder retryOnConnectionFailure(boolean retryOnConnectionFailure) {
            Builder $this$retryOnConnectionFailure_u24lambda_u246 = this;
        ...
        public final Builder authenticator(Authenticator authenticator) {
            ...
            Builder $this$authenticator_u24lambda_u247 = this;
        ...
        public final Builder followRedirects(boolean followRedirects) {
            Builder $this$followRedirects_u24lambda_u248 = this;
        ...
        public final Builder followSslRedirects(boolean followProtocolRedirects) {
            Builder $this$followSslRedirects_u24lambda_u249 = this;
        ...
        public final Builder cookieJar(CookieJar cookieJar) {
            ...
            Builder $this$cookieJar_u24lambda_u2410 = this;
            $this$cookieJar_u24lambda_u2410.cookieJar = cookieJar;
            return this;
        }

        public final Builder cache(Cache cache) {
            Builder $this$cache_u24lambda_u2411 = this;
        ...
        public final Builder dns(Dns dns) {
            ...
            Builder $this$dns_u24lambda_u2412 = this;
        ...
        public final Builder proxy(Proxy proxy) {
            Builder $this$proxy_u24lambda_u2413 = this;
        ...
        public final Builder proxySelector(ProxySelector proxySelector) {
            ...
            Builder $this$proxySelector_u24lambda_u2414 = this;
        ...
        public final Builder proxyAuthenticator(Authenticator proxyAuthenticator) {
            ...
            Builder $this$proxyAuthenticator_u24lambda_u2415 = this;
        ...
        public final Builder socketFactory(SocketFactory socketFactory) {
            ...
            Builder $this$socketFactory_u24lambda_u2417 = this;
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            Builder $this$sslSocketFactory_u24lambda_u2418 = this;
            ...
            $this$sslSocketFactory_u24lambda_u2418.x509TrustManagerOrNull = trustManager;
            Platform platform = Platform.INSTANCE.get();
            X509TrustManager x509TrustManager = $this$sslSocketFactory_u24lambda_u2418.x509TrustManagerOrNull;
            Intrinsics.checkNotNull(x509TrustManager);
            $this$sslSocketFactory_u24lambda_u2418.certificateChainCleaner = platform.buildCertificateChainCleaner(x509TrustManager);
            return this;
        }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sslSocketFactory, X509TrustManager trustManager) {
            ...
            Builder $this$sslSocketFactory_u24lambda_u2419 = this;
            ...
            $this$sslSocketFactory_u24lambda_u2419.certificateChainCleaner = CertificateChainCleaner.INSTANCE.get(trustManager);
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> connectionSpecs) {
            ...
            Builder $this$connectionSpecs_u24lambda_u2420 = this;
        ...
        public final Builder protocols(List<? extends Protocol> protocols) {
            ...
            Builder $this$protocols_u24lambda_u2425 = this;
            ...
            $this$protocols_u24lambda_u2425.protocols = unmodifiableList;
            return this;
        }

        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier) {
            Intrinsics.checkNotNullParameter(hostnameVerifier, "hostnameVerifier");
            Builder $this$hostnameVerifier_u24lambda_u2426 = this;
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner) {
            ...
            Builder $this$certificatePinner_u24lambda_u2427 = this;
        ...
        public final Builder callTimeout(long timeout, TimeUnit unit) {
            ...
            Builder $this$callTimeout_u24lambda_u2428 = this;
        ...
        public final Builder callTimeout(Duration duration) {
            ...
            Builder $this$callTimeout_u24lambda_u2429 = this;
        ...
        public final Builder connectTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$connectTimeout_u24lambda_u2430 = this;
        ...
        public final Builder connectTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$connectTimeout_u24lambda_u2431 = this;
        ...
        public final Builder readTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$readTimeout_u24lambda_u2432 = this;
        ...
        public final Builder readTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$readTimeout_u24lambda_u2433 = this;
        ...
        public final Builder writeTimeout(long timeout, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$writeTimeout_u24lambda_u2434 = this;
        ...
        public final Builder writeTimeout(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$writeTimeout_u24lambda_u2435 = this;
        ...
        public final Builder pingInterval(long interval, TimeUnit unit) {
            Intrinsics.checkNotNullParameter(unit, "unit");
            Builder $this$pingInterval_u24lambda_u2436 = this;
        ...
        public final Builder pingInterval(Duration duration) {
            Intrinsics.checkNotNullParameter(duration, "duration");
            Builder $this$pingInterval_u24lambda_u2437 = this;
        ...
        public final Builder minWebSocketMessageToCompress(long bytes) {
            Builder $this$minWebSocketMessageToCompress_u24lambda_u2439 = this;
            if (!(bytes >= 0)) {
    ...
    /* compiled from: OkHttpClient.kt */
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, d2 = {"Lokhttp3/OkHttpClient$Companion;", "", "()V", "DEFAULT_CONNECTION_SPECS", "", "Lokhttp3/ConnectionSpec;", "getDEFAULT_CONNECTION_SPECS$okhttp", "()Ljava/util/List;", "DEFAULT_PROTOCOLS", "Lokhttp3/Protocol;", "getDEFAULT_PROTOCOLS$okhttp", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes8.dex */
