...
public final class TaskLoggerKt {
    ...
    public static final void log(Task task, TaskQueue queue, String message) {
        ...
        StringBuilder append = new StringBuilder().append(queue.getName()).append(' ');
