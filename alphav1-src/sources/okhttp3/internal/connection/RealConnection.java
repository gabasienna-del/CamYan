    ...
    */
    ...
    private final void connectSocket(int connectTimeout, int readTimeout, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            ConnectException $this$connectSocket_u24lambda_u241 = new ConnectException("Failed to connect to " + this.route.socketAddress());
            $this$connectSocket_u24lambda_u241.initCause(e);
            throw $this$connectSocket_u24lambda_u241;
        }
    }
    ...
    private final void connectTls(ConnectionSpecSelector connectionSpecSelector) throws IOException {
        ...
        try {
            ...
            try {
                ...
                String maybeProtocol = connectionSpec.supportsTlsExtensions() ? Platform.INSTANCE.get().getSelectedProtocol(sslSocket) : null;
    ...
    public final RealWebSocket.Streams newWebSocketStreams$okhttp(final Exchange exchange) throws SocketException {
        ...
        return new RealWebSocket.Streams(source, sink) { // from class: okhttp3.internal.connection.RealConnection$newWebSocketStreams$1
