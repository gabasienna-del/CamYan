...
public class Platform {
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager trustManager) {
        Intrinsics.checkNotNullParameter(trustManager, "trustManager");
        try {
            SSLContext $this$newSslSocketFactory_u24lambda_u241 = newSSLContext();
            $this$newSslSocketFactory_u24lambda_u241.init(null, new TrustManager[]{trustManager}, null);
            SSLSocketFactory socketFactory = $this$newSslSocketFactory_u24lambda_u241.getSocketFactory();
