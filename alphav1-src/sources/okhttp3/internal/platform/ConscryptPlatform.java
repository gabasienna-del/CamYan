...
public final class ConscryptPlatform extends Platform {
    ...
    public X509TrustManager platformTrustManager() {
        TrustManagerFactory $this$platformTrustManager_u24lambda_u240 = TrustManagerFactory.getInstance(TrustManagerFactory.getDefaultAlgorithm());
        $this$platformTrustManager_u24lambda_u240.init((KeyStore) null);
        TrustManager[] trustManagers = $this$platformTrustManager_u24lambda_u240.getTrustManagers();
    ...
    public void configureTlsExtensions(SSLSocket sslSocket, String hostname, List<Protocol> protocols) {
        ...
        if (Conscrypt.isConscrypt(sslSocket)) {
            ...
            Conscrypt.setApplicationProtocols(sslSocket, (String[]) $this$toTypedArray$iv.toArray(new String[0]));
            return;
        }
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager trustManager) {
        ...
        SSLContext $this$newSslSocketFactory_u24lambda_u242 = newSSLContext();
        $this$newSslSocketFactory_u24lambda_u242.init(null, new TrustManager[]{trustManager}, null);
        SSLSocketFactory socketFactory = $this$newSslSocketFactory_u24lambda_u242.getSocketFactory();
        Intrinsics.checkNotNullExpressionValue(socketFactory, "newSSLContext().apply {\n…null)\n    }.socketFactory");
        return socketFactory;
    }

    /* compiled from: ConscryptPlatform.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\"\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\b2\b\b\u0002\u0010\t\u001a\u00020\b2\b\b\u0002\u0010\n\u001a\u00020\bJ\b\u0010\u000b\u001a\u0004\u0018\u00010\fR\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0003\u0010\u0005¨\u0006\r"}, d2 = {"Lokhttp3/internal/platform/ConscryptPlatform$Companion;", "", "()V", "isSupported", "", "()Z", "atLeastVersion", "major", "", "minor", "patch", "buildIfSupported", "Lokhttp3/internal/platform/ConscryptPlatform;", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    /* loaded from: classes8.dex */
    ...
    static {
        boolean z = false;
        try {
            Class.forName("org.conscrypt.Conscrypt$Version", false, INSTANCE.getClass().getClassLoader());
