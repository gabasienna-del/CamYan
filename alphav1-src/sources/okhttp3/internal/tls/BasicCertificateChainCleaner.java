    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        for (int c = 0; c < 9; c++) {
            ...
            if (trustedCert != null) {
                ...
                Intrinsics.checkNotNullExpressionValue(i, "queue.iterator()");
                while (i.hasNext()) {
                    Object next = i.next();
