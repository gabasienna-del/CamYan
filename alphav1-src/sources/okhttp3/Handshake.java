...
public final class Handshake {
    ...
    public final List<Certificate> m1796deprecated_peerCertificates() {
    ...
    public final Principal m1797deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1794deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1795deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder append = new StringBuilder().append("Handshake{tlsVersion=").append(this.tlsVersion).append(" cipherSuite=").append(this.cipherSuite).append(" peerCertificates=").append(peerCertificatesString).append(" localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake get(SSLSession $this$handshake) throws IOException {
            ...
            return new Handshake(tlsVersion, cipherSuite, toImmutableList($this$handshake.getLocalCertificates()), new Function0<List<? extends Certificate>>() { // from class: okhttp3.Handshake$Companion$handshake$1
                /* JADX INFO: Access modifiers changed from: package-private */
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
        ...
        public final Handshake m1799deprecated_get(SSLSession sslSession) throws IOException {
