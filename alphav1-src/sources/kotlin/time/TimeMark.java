...
public interface TimeMark {
    ...
    TimeMark mo1498minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1500plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1645plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1644minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1500plusLRDsOJo(Duration.m1560unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1540isNegativeimpl($this.mo1497elapsedNowUwyO8pc());
        }
