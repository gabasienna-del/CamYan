...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1498minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1499minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1500plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1502minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1500plusLRDsOJo(Duration.m1560unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1506compareToLRDsOJo($this.mo1499minusUwyO8pc(other), Duration.INSTANCE.m1610getZEROUwyO8pc());
        }
    }
}
