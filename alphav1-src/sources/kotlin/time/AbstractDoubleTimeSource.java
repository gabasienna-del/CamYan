...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    public static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1497elapsedNowUwyO8pc() {
            return Duration.m1542minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1500plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1543plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1499minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1512equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1539isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1610getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1542minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1512equalsimpl0(startedAtDiff, Duration.m1560unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1610getZEROUwyO8pc() : Duration.m1543plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1512equalsimpl0(mo1499minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1610getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1535hashCodeimpl(Duration.m1543plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1556toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1610getZEROUwyO8pc(), null);
    }
}
