    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        /*
            ...
            r1 = 0
            if (r6 <= 0) goto L10
            int r2 = kotlin.UByte$$ExternalSyntheticBackport5.m(r4, r5)
            if (r2 > 0) goto L17
            goto L16
        L10:
            int r2 = kotlin.UByte$$ExternalSyntheticBackport5.m(r4, r5)
        ...
        L18:
            r3.hasNext = r0
            int r0 = kotlin.UInt.m276constructorimpl(r6)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m270boximpl(m1407nextpVg5ArA());
    }
    ...
    public int m1407nextpVg5ArA() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = UInt.m276constructorimpl(this.next + this.step);
        }
        return value;
    }
}
