...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1389getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m355constructorimpl(this.first ^ ULong.m355constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m355constructorimpl(this.last ^ ULong.m355constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m401toStringimpl(this.first)).append("..").append((Object) ULong.m401toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m401toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m401toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1415fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
