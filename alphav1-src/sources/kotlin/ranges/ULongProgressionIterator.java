...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    */
    private ULongProgressionIterator(long r4, long r6, long r8) {
        ...
        L1c:
            r3.hasNext = r1
            long r0 = kotlin.ULong.m355constructorimpl(r8)
            r3.step = r0
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m349boximpl(m1416nextsVKNKU());
    }
    ...
    public long m1416nextsVKNKU() {
        ...
        if (value == this.finalElement) {
            ...
            this.next = ULong.m355constructorimpl(this.next + this.step);
        }
        return value;
    }
}
