...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m513boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m515constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m518equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m519equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public static int m522hashCodeimpl(short[] sArr) {
        return Arrays.hashCode(sArr);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m526toStringimpl(short[] sArr) {
    ...
    public boolean m527addxj2QHRw(short s) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object obj) {
        return m518equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m522hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m526toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UShort) {
            return m528containsxj2QHRw(((UShort) element).getData());
        }
        return false;
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static short[] m514constructorimpl(int size) {
        return m515constructorimpl(new short[size]);
    }

    /* renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m520getMh2AYeg(short[] arg0, int index) {
        return UShort.m462constructorimpl(arg0[index]);
    }

    /* renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m525set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }
    ...
    public static java.util.Iterator<UShort> m524iteratorimpl(short[] arg0) {
        return new Iterator(arg0);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UShort> iterator() {
        return m524iteratorimpl(this.storage);
    }
    ...
    public static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m456boximpl(m530nextMh2AYeg());
        }
        ...
        public short m530nextMh2AYeg() {
            ...
            int i = this.index;
            this.index = i + 1;
            return UShort.m462constructorimpl(sArr[i]);
        }
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m528containsxj2QHRw(short element) {
        return m516containsxj2QHRw(this.storage, element);
    }

    /* renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m516containsxj2QHRw(short[] arg0, short element) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m517containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m517containsAllimpl(short[] arg0, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m523isEmptyimpl(short[] arg0) {
        return arg0.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m523isEmptyimpl(this.storage);
    }
}
