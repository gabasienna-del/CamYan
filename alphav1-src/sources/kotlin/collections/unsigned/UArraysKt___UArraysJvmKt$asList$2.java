...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof ULong) {
            return m693containsVKZWuLQ(((ULong) element).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int index) {
        return ULong.m349boximpl(m694getsVKNKU(index));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object element) {
        if (element instanceof ULong) {
            return m695indexOfVKZWuLQ(((ULong) element).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object element) {
        if (element instanceof ULong) {
            return m696lastIndexOfVKZWuLQ(((ULong) element).getData());
        }
        return -1;
    }
    ...
    public int get_size() {
        return ULongArray.m416getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return ULongArray.m418isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m693containsVKZWuLQ(long element) {
        return ULongArray.m411containsVKZWuLQ(this.$this_asList, element);
    }

    /* renamed from: get-s-VKNKU, reason: not valid java name */
    public long m694getsVKNKU(int index) {
        return ULongArray.m415getsVKNKU(this.$this_asList, index);
    }

    /* renamed from: indexOf-VKZWuLQ, reason: not valid java name */
    public int m695indexOfVKZWuLQ(long element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* renamed from: lastIndexOf-VKZWuLQ, reason: not valid java name */
    public int m696lastIndexOfVKZWuLQ(long element) {
