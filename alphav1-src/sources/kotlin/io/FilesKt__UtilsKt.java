...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final boolean copyRecursively(File $this$copyRecursively, File target, boolean overwrite, final Function2<? super File, ? super IOException, ? extends OnErrorAction> onError) {
        boolean stillExists;
    ...
    public static final File normalize(File $this$normalize) {
        ...
        List<File> normalize$FilesKt__UtilsKt = normalize$FilesKt__UtilsKt($this$normalize_u24lambda_u245.getSegments());
        String separator = File.separator;
        Intrinsics.checkNotNullExpressionValue(separator, "separator");
