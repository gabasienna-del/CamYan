...
public final class UStringsKt {
    ...
    public static final String m1494toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1496toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1495toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1493toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m276constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m193boximpl(UByte.m199constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m276constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m456boximpl(UShort.m462constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m276constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m276constructorimpl(result * uradix);
            result = UInt.m276constructorimpl(UInt.m276constructorimpl(digit) + result2);
            compare2 = Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
        }
        return UInt.m270boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m355constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (compare > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UByte$$ExternalSyntheticBackport3.m(-1L, uradix);
            ...
            long result2 = ULong.m355constructorimpl(result * uradix);
            result = ULong.m355constructorimpl(ULong.m355constructorimpl(UInt.m276constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m349boximpl(result);
    }
}
