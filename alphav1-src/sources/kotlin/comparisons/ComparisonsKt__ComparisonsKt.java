...
public class ComparisonsKt__ComparisonsKt {
    ...
    public static final int compareBy$lambda$0$ComparisonsKt__ComparisonsKt(Function1[] selectors, Object a, Object b) {
        Intrinsics.checkNotNullParameter(selectors, "$selectors");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int then$lambda$1$ComparisonsKt__ComparisonsKt(Comparator this_then, Comparator comparator, Object a, Object b) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int thenDescending$lambda$2$ComparisonsKt__ComparisonsKt(Comparator this_thenDescending, Comparator comparator, Object a, Object b) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int nullsFirst$lambda$3$ComparisonsKt__ComparisonsKt(Comparator comparator, Object a, Object b) {
        Intrinsics.checkNotNullParameter(comparator, "$comparator");
        if (a == b) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final int nullsLast$lambda$4$ComparisonsKt__ComparisonsKt(Comparator comparator, Object a, Object b) {
        Intrinsics.checkNotNullParameter(comparator, "$comparator");
        if (a == b) {
            return 0;
        }
