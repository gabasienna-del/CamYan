...
public final class ULong implements Comparable<ULong> {
    ...
    private static final int m350compareTo7apg3OU(long arg0, byte other) {
        int compare;
        compare = Long.compare(arg0 ^ Long.MIN_VALUE, m355constructorimpl(other & 255) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    private static final int m354compareToxj2QHRw(long arg0, short other) {
        int compare;
        compare = Long.compare(arg0 ^ Long.MIN_VALUE, m355constructorimpl(other & WebSocketProtocol.PAYLOAD_SHORT_MAX) ^ Long.MIN_VALUE);
        return compare;
    }
    ...
    private static final int m353compareToWZ4Q5Ns(long arg0, int other) {
        int compare;
        compare = Long.compare(arg0 ^ Long.MIN_VALUE, m355constructorimpl(other & 4294967295L) ^ Long.MIN_VALUE);
        return compare;
    }
