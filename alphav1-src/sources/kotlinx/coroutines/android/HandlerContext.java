...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1740scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        final Runnable block = new Runnable() { // from class: kotlinx.coroutines.android.HandlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1
            ...
            public final void run() {
                CancellableContinuation $this$scheduleResumeAfterDelay_u24lambda_u242_u24lambda_u241 = CancellableContinuation.this;
                $this$scheduleResumeAfterDelay_u24lambda_u242_u24lambda_u241.resumeUndispatched(this, Unit.INSTANCE);
            }
        };
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            ...
            cancelOnRejection(continuation.get$context(), block);
        }
    }
