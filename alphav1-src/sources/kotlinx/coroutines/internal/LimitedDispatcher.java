...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo1740scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1740scheduleResumeAfterDelay(timeMillis, continuation);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public LimitedDispatcher(CoroutineDispatcher coroutineDispatcher, int parallelism) {
    ...
    public void mo1739dispatch(CoroutineContext context, Runnable block) {
        ...
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo1739dispatch(this, worker);
        }
    }
    ...
    private final void dispatchInternal(Runnable block, Function1<? super Worker, Unit> startWorker) {
        Runnable task;
        this.queue.addLast(block);
        if (runningWorkers$FU.get(this) < this.parallelism && tryAllocateWorker() && (task = obtainTaskOrDeallocateWorker()) != null) {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo1739dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
