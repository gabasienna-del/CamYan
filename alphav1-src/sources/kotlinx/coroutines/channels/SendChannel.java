...
public interface SendChannel<E> {
    ...
    Object mo1683trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1683trySendJP2dKIU(e);
            if (ChannelResult.m1703isSuccessimpl(result)) {
                return true;
            }
            Throwable m1697exceptionOrNullimpl = ChannelResult.m1697exceptionOrNullimpl(result);
