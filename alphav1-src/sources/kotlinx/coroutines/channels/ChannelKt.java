...
public final class ChannelKt {
    ...
    public static final <T> T m1689getOrElseWpGqRn0(Object obj, Function1<? super Throwable, ? extends T> function1) {
        return obj instanceof ChannelResult.Failed ? function1.invoke(ChannelResult.m1697exceptionOrNullimpl(obj)) : obj;
    }

    /* renamed from: onSuccess-WpGqRn0 */
    public static final <T> Object m1692onSuccessWpGqRn0(Object $this$onSuccess_u2dWpGqRn0, Function1<? super T, Unit> function1) {
    ...
    public static final <T> Object m1691onFailureWpGqRn0(Object $this$onFailure_u2dWpGqRn0, Function1<? super Throwable, Unit> function1) {
        if ($this$onFailure_u2dWpGqRn0 instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1697exceptionOrNullimpl($this$onFailure_u2dWpGqRn0));
        }
        return $this$onFailure_u2dWpGqRn0;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1690onClosedWpGqRn0(Object $this$onClosed_u2dWpGqRn0, Function1<? super Throwable, Unit> function1) {
        if ($this$onClosed_u2dWpGqRn0 instanceof ChannelResult.Closed) {
            function1.invoke(ChannelResult.m1697exceptionOrNullimpl($this$onClosed_u2dWpGqRn0));
        }
