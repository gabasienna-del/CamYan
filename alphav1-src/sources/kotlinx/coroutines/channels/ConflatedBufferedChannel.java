...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object $this$onClosed_u2dWpGqRn0$iv = conflatedBufferedChannel.m1711trySendImplMj0NB7M(e, true);
        if ($this$onClosed_u2dWpGqRn0$iv instanceof ChannelResult.Closed) {
            ChannelResult.m1697exceptionOrNullimpl($this$onClosed_u2dWpGqRn0$iv);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object $this$onSuccess_u2dWpGqRn0$iv = conflatedBufferedChannel.m1711trySendImplMj0NB7M(e, true);
    ...
    public Object mo1683trySendJP2dKIU(E element) {
        return m1711trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1711trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1709trySendDropLatestMj0NB7M(element, isSendOp) : m1710trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1709trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException it;
        Object result = super.mo1683trySendJP2dKIU(element);
        if (ChannelResult.m1703isSuccessimpl(result) || ChannelResult.m1701isClosedimpl(result)) {
            return result;
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x0099, code lost:
        ...
        return kotlinx.coroutines.channels.ChannelResult.INSTANCE.m1706closedJP2dKIU(getSendException());
     */
    ...
    */
    private final java.lang.Object m1710trySendDropOldestJP2dKIU(E r21) {
        /*
            Method dump skipped, instructions count: 260
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.ConflatedBufferedChannel.m1710trySendDropOldestJP2dKIU(java.lang.Object):java.lang.Object");
    }
    ...
    public void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object it = mo1683trySendJP2dKIU(element);
        if (!(it instanceof ChannelResult.Failed)) {
            ...
            ChannelResult.m1697exceptionOrNullimpl(it);
