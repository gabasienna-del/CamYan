...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1687receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1687receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1688tryReceivePtdJZtk() {
        return this._channel.mo1688tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1683trySendJP2dKIU(E element) {
        return this._channel.mo1683trySendJP2dKIU(element);
    }
    ...
    public ChannelCoroutine(CoroutineContext parentContext, Channel<E> channel, boolean initParentJob, boolean active) {
