...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ChannelLimitedFlowMerge(Iterable<? extends Flow<? extends T>> iterable, CoroutineContext context, int capacity, BufferOverflow onBufferOverflow) {
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        Iterable $this$forEach$iv = this.flows;
        for (Flow element$iv : $this$forEach$iv) {
            Flow flow = element$iv;
            BuildersKt__Builders_commonKt.launch$default(producerScope, null, null, new ChannelLimitedFlowMerge$collectTo$2$1(flow, collector, null), 3, null);
        }
