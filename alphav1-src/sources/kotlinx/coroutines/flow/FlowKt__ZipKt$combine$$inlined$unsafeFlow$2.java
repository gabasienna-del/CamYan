...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        InlineMarker.mark(4);
        new ContinuationImpl($completion) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$2.1
            int label;
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(collector, flowArr, flowKt__ZipKt$combine$5$1, flowKt__ZipKt$combine$5$2, $completion);
        InlineMarker.mark(1);
