...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:19:0x00aa A[Catch: all -> 0x00d8, TryCatch #0 {all -> 0x00d8, blocks: (B:13:0x003d, B:17:0x00a1, B:19:0x00aa, B:26:0x00bf, B:27:0x00c2, B:33:0x0055, B:36:0x0067, B:37:0x008f, B:39:0x0077, B:41:0x007b), top: B:7:0x0022 }] */
    ...
    /* JADX WARN: Type inference failed for: r2v13, types: [kotlinx.coroutines.flow.FlowCollector, java.lang.Object] */
    ...
    /* JADX WARN: Type inference failed for: r8v9, types: [kotlinx.coroutines.flow.SharedFlowSlot, java.lang.Object] */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:27:0x00d4 -> B:15:0x009e). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static /* synthetic */ <T> java.lang.Object collect$suspendImpl(kotlinx.coroutines.flow.SharedFlowImpl<T> r7, kotlinx.coroutines.flow.FlowCollector<? super T> r8, kotlin.coroutines.Continuation<?> r9) {
        /*
    ...
    public boolean tryEmit(T value) {
        ...
        for (Continuation cont : continuationArr) {
            if (cont != null) {
                ...
                cont.resumeWith(Result.m181constructorimpl(Unit.INSTANCE));
            }
        }
        return emitted;
    }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        for (Continuation r : continuationArr) {
            if (r != null) {
                ...
                r.resumeWith(Result.m181constructorimpl(Unit.INSTANCE));
            }
        }
    ...
    */
    ...
    private final Object tryTakeValue(SharedFlowSlot slot) {
        ...
        for (Continuation resume : continuationArr) {
            if (resume != null) {
                Result.Companion companion = Result.INSTANCE;
                resume.resumeWith(Result.m181constructorimpl(Unit.INSTANCE));
            }
        }
        return value;
    }
        ...
        if (AbstractSharedFlow.access$getNCollectors(this_$iv) != 0 && ($this$forEach$iv$iv = AbstractSharedFlow.access$getSlots(this_$iv)) != null) {
            ...
            while (i < length) {
                ...
                if (element$iv$iv != null && (cont = (slot = (SharedFlowSlot) element$iv$iv).cont) != null && sharedFlowImpl.tryPeekLocked(slot) >= 0) {
                    if (resumeCount >= continuationArr.length) {
                        ?? copyOf = Arrays.copyOf(continuationArr, Math.max(2, continuationArr.length * 2));
                        Intrinsics.checkNotNullExpressionValue(copyOf, "copyOf(this, newSize)");
                        continuationArr = copyOf;
                    }
                    continuationArr[resumeCount] = cont;
                    slot.cont = null;
                    resumeCount++;
                }
                i++;
