...
public class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public ChannelFlowBuilder(Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2, CoroutineContext context, int capacity, BufferOverflow onBufferOverflow) {
