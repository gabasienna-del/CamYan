    ...
    public final Object invokeSuspend(Object $result) {
        ...
        switch (this.label) {
            case 0:
                ...
                fixedPeriodTicker$default = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, flowKt__DelayKt$sample$2.$periodMillis, 0L, 2, null);
        ...
        while (lastValue.element != NullSurrogateKt.DONE) {
            SelectImplementation $this$select_u24lambda_u241$iv = new SelectImplementation(flowKt__DelayKt$sample$2.get$context());
            ...
            if ($this$select_u24lambda_u241$iv.doSelect(flowKt__DelayKt$sample$2) == coroutine_suspended) {
