...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        Function0 nullArrayFactory$FlowKt__ZipKt;
        InlineMarker.mark(4);
        new ContinuationImpl($completion) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1.1
            int label;
        ...
        InlineMarker.mark(0);
        CombineKt.combineInternal(collector, flowArr, nullArrayFactory$FlowKt__ZipKt, flowKt__ZipKt$combineUnsafe$1$1, $completion);
        InlineMarker.mark(1);
