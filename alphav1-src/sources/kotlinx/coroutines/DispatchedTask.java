            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        if (DebugKt.getRECOVER_STACK_TRACES()) {
                            try {
                                if (continuation instanceof CoroutineStackFrame) {
                                    ...
                                    continuation.resumeWith(Result.m181constructorimpl(ResultKt.createFailure(cancellationException)));
                                }
                            } catch (Throwable th2) {
                                th = th2;
                        ...
                        continuation.resumeWith(Result.m181constructorimpl(ResultKt.createFailure(exception)));
                    } else {
                        Result.Companion companion3 = Result.INSTANCE;
                        continuation.resumeWith(Result.m181constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m181constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.INSTANCE;
                        result = Result.m181constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m184exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
