...
public final class SupervisorKt {
    public static final CompletableJob SupervisorJob(Job parent) {
    ...
    public static final /* synthetic */ Job m1678SupervisorJob(Job parent) {
        return SupervisorJob(parent);
    }

    /* renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1679SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1678SupervisorJob(job);
    }
