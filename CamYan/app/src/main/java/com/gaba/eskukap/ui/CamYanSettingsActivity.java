...
public class CamYanSettingsActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle b){
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.settings_container,new Frag())
                .commit();
    }

    void updatePreview(){
        String uri= PreferenceManager.getDefaultSharedPreferences(this)
                .getString("fake_photo_uri",null);
        ...
        @Override public void onActivityResult(int r,int c,Intent d){
            ...
            if(r==REQ &&c==AppCompatActivity.RESULT_OK&&d!=null){
                ...
                requireContext().getContentResolver().takePersistableUriPermission(
                        u,d.getFlags()&(Intent.FLAG_GRANT_READ_URI_PERMISSION|
                        Intent.FLAG_GRANT_WRITE_URI_PERMISSION));

                SharedPreferences prefs=PreferenceManager.getDefaultSharedPreferences(requireContext());
                prefs.edit().putString("fake_photo_uri",u.toString()).apply();
